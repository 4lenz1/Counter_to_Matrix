...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gridLayout->addWidget(lineout, 0, 1, 1, 1);
        ...
        sizePolicy.setHeightForWidth(btnClick->sizePolicy().hasHeightForWidth());
        btnClick->setSizePolicy(sizePolicy);
        QFont font;
        font.setFamily(QStringLiteral("Arial"));
        font.setPointSize(40);
        font.setStyleStrategy(QFont::PreferAntialias);
        btnClick->setFont(font);

        gridLayout->addWidget(btnClick, 1, 0, 1, 2);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        btnOpen->setText(QApplication::translate("MainWindow", "Open File", 0));
        btnClick->setText(QApplication::translate("MainWindow", "Get Martix ", 0));
